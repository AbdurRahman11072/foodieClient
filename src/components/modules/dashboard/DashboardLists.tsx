        ...
        <div className="space-y-4">
          {(Array.isArray(meals) ? meals : [])
            ...
            .map((meal, index) => (
              <div
                key={index}
                className="flex items-center justify-between group p-2 rounded-xl hover:bg-white/50 dark:hover:bg-white/5 transition-colors"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground font-medium">
                      {meal._count.mealId} Orders
                    </p>
                  </div>
                </div>
                <Badge
                  variant="secondary"
                  className="bg-primary/5 text-primary border-none text-[10px] uppercase tracking-wider font-bold"
                >
                  Trending
                </Badge>
              </div>
            ...
            .map((user, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground mt-1 font-medium truncate max-w-[120px]">
                    {user.email}
                  </p>
                </div>
                <Badge
                  variant="outline"
                  className="text-[10px] uppercase font-bold border-zinc-200 dark:border-zinc-700"
                >
                  {user.role}
                </Badge>
              </div>
